...
public:
    ...
    */
    Function(const char * name) {{profile.noexceptMacro}};
    ...
    */
    inline ReturnType operator()(Arguments&... arguments) const {{profile.noexceptMacro}};
    ...
    *    This method respects currently activated callbacks and logging
    */
    inline ReturnType call(Arguments&... arguments) const {{profile.noexceptMacro}};
    ...
    */
    inline ReturnType directCall(Arguments... arguments) const {{profile.noexceptMacro}};
    ...
    */
    inline void setBeforeCallback(BeforeCallback callback) {{profile.noexceptMacro}};

    /**
    *  @brief
    *    Clears any previously registered before callback
    */
    inline void clearBeforeCallback() {{profile.noexceptMacro}};
    ...
    */
    inline void setAfterCallback(AfterCallback callback) {{profile.noexceptMacro}};

    /**
    *  @brief
    *    Clears any previously registered after callback
    */
    inline void clearAfterCallback() {{profile.noexceptMacro}};
    ...
    *    The beforeCallback
    */
    inline BeforeCallback beforeCallback() const {{profile.noexceptMacro}};
    ...
    *    The afterCallback
    */
    inline AfterCallback afterCallback() const {{profile.noexceptMacro}};

    virtual bool hasState() const {{profile.noexceptMacro}} override;
    virtual bool hasState(int pos) const {{profile.noexceptMacro}} override;

    virtual AbstractState & state() const {{profile.noexceptMacro}} override;
    virtual AbstractState & state(int pos) const {{profile.noexceptMacro}} override;

    virtual void resizeStates(int count) {{profile.noexceptMacro}} override;
