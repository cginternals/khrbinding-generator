...
template <typename T>
{{api.identifier|binding}}BINDING_CONSTEXPR SharedBitfieldBase<T>::SharedBitfieldBase(T value)
: m_value{value}
{
}

template <typename T>
{{api.identifier|binding}}BINDING_CONSTEXPR SharedBitfieldBase<T>::operator T() const
{
    return m_value;
}
...
{{api.identifier|binding}}BINDING_CONSTEXPR SharedBitfield<Type>::SharedBitfield(ConstructionType value)
...
template <typename Type>
{{api.identifier|binding}}BINDING_CONSTEXPR SharedBitfield<Type>::SharedBitfield(typename std::underlying_type<Type>::type value)
: SharedBitfieldBase<typename std::underlying_type<Type>::type>(value)
{
}

template <typename Type>
{{api.identifier|binding}}BINDING_CONSTEXPR SharedBitfield<Type>::operator Type() const
{
...
template <typename Type>
template <typename... T>
{{api.identifier|binding}}BINDING_CONSTEXPR auto SharedBitfield<Type>::operator==(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, bool>::type
{
...
template <typename Type>
template <typename T>
{{api.identifier|binding}}BINDING_CONSTEXPR auto SharedBitfield<Type>::operator==(T other) const -> typename std::enable_if<is_member_of_SharedBitfield<T, Type>::value, bool>::type
{
    return static_cast<UnderlyingType>(*this) == static_cast<UnderlyingType>(other);
}
...
template <typename ConstructionType>
{{api.identifier|binding}}BINDING_CONSTEXPR SharedBitfield<Type, Types...>::SharedBitfield(ConstructionType value)
...
template <typename Type, typename... Types>
{{api.identifier|binding}}BINDING_CONSTEXPR SharedBitfield<Type, Types...>::SharedBitfield(typename std::underlying_type<Type>::type value)
: SharedBitfield<Types...>(value)
{
}

template <typename Type, typename... Types>
{{api.identifier|binding}}BINDING_CONSTEXPR SharedBitfield<Type, Types...>::operator Type() const
{
    return static_cast<Type>(this->m_value);
}
...
template <typename Type, typename... Types>
template <typename... T>
{{api.identifier|binding}}BINDING_CONSTEXPR auto SharedBitfield<Type, Types...>::operator==(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type, Types...>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, bool>::type
{
    return static_cast<UnderlyingType>(*this) == static_cast<UnderlyingType>(other);
}
...
template <typename Type, typename... Types>
template <typename T>
{{api.identifier|binding}}BINDING_CONSTEXPR auto SharedBitfield<Type, Types...>::operator==(T other) const -> typename std::enable_if<is_member_of_SharedBitfield<T, Type, Types...>::value, bool>::type
{
    return static_cast<UnderlyingType>(*this) == static_cast<UnderlyingType>(other);
}
...
{{api.identifier|binding}}BINDING_CONSTEXPR typename std::enable_if<std::is_base_of<SharedBitfieldBase<typename std::underlying_type<typename std::enable_if<std::is_enum<Enum>::value, Enum>::type>::type>, ConvertibleEnum>::value, Enum>::type
