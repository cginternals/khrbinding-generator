...
class {{ucbinding}}_TEMPLATE_API SharedBitfield;
...
struct {{ucbinding}}_TEMPLATE_API is_member_of_SharedBitfield
{
...
struct {{ucbinding}}_TEMPLATE_API is_member_of_SharedBitfield<T, U, Types...>
{
...
struct {{ucbinding}}_TEMPLATE_API prepend_to_SharedBitfield
{
};
...
*/
template<typename T, typename... Types>
struct {{ucbinding}}_TEMPLATE_API prepend_to_SharedBitfield<T, SharedBitfield<Types...>>
{
...
*/
template<typename, typename>
struct {{ucbinding}}_TEMPLATE_API intersect_SharedBitfield
{
...
struct {{ucbinding}}_TEMPLATE_API intersect_SharedBitfield<SharedBitfield<T, Types...>, SharedBitfield<OtherTypes...>>
{
...
*/
template <typename T>
class {{ucbinding}}_TEMPLATE_API SharedBitfieldBase
{
public:
    ...
    */
    {{ucbinding}}_CONSTEXPR inline SharedBitfieldBase(T value);
    ...
    *    The bitfield value
    */
    {{ucbinding}}_CONSTEXPR inline explicit operator T() const;
...
class {{ucbinding}}_TEMPLATE_API SharedBitfield<Type> : public SharedBitfieldBase<typename std::underlying_type<Type>::type>
{
public:
    ...
    */
    ...
    {{ucbinding}}_CONSTEXPR inline SharedBitfield(ConstructionType value);
    ...
    *    The value of this SharedBitfield
    */
    {{ucbinding}}_CONSTEXPR inline SharedBitfield(typename std::underlying_type<Type>::type value);
    ...
    */
    {{ucbinding}}_CONSTEXPR inline operator Type() const;
    ...
    */
    template <typename... T>
    {{ucbinding}}_CONSTEXPR inline auto operator|(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, typename intersect_SharedBitfield<SharedBitfield<Type>, SharedBitfield<T...>>::type>::type;
    ...
    */
    template <typename... T>
    {{ucbinding}}_CONSTEXPR inline auto operator==(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, bool>::type;
    ...
    */
    template <typename T>
    {{ucbinding}}_CONSTEXPR inline auto operator==(T other) const -> typename std::enable_if<is_member_of_SharedBitfield<T, Type>::value, bool>::type;
};
...
class {{ucbinding}}_TEMPLATE_API SharedBitfield<Type, Types...> : public SharedBitfield<Types...>
{
public:
    ...
    */
    template <typename... T>
    {{ucbinding}}_CONSTEXPR inline auto operator|(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type, Types...>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, typename intersect_SharedBitfield<SharedBitfield<Type, Types...>, SharedBitfield<T...>>::type>::type;
    ...
    */
    template <typename... T>
    {{ucbinding}}_CONSTEXPR inline auto operator==(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type, Types...>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, bool>::type;
    ...
    */
    template <typename T>
    {{ucbinding}}_CONSTEXPR inline auto operator==(T other) const -> typename std::enable_if<is_member_of_SharedBitfield<T, Type, Types...>::value, bool>::type;
};
...
{{ucbinding}}_CONSTEXPR inline typename std::enable_if<std::is_base_of<SharedBitfieldBase<typename std::underlying_type<typename std::enable_if<std::is_enum<Enum>::value, Enum>::type>::type>, ConvertibleEnum>::value, Enum>::type
...
#include <{{binding}}/SharedBitfield.inl>
