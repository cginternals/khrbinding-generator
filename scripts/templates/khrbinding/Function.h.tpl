...
*/
template <typename ReturnType, typename... Arguments>
struct {{ucbinding}}_TEMPLATE_API CallbackType
{
...
struct {{ucbinding}}_TEMPLATE_API CallbackType<void, Arguments...>
{
...
*/
template <typename ReturnType, typename... Arguments>
class {{ucbinding}}_TEMPLATE_API Function : public AbstractFunction
{
public:
