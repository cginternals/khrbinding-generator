...
*/
class {{ucbinding}}_API AbstractFunction
{
...
public:
    ...
    *
    *  @param[in] name
    *    The actual exported OpenGL API function name, including the '{{api}}' prefix
    */
...
protected:
    const char * m_name;   ///< The OpenGL API function name, including the '{{api}}' prefix
};
