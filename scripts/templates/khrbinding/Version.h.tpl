...
public:
    ...
    */
    {{ucbinding}}_CONSTEXPR inline Version();
    ...
    *    The minor version
    */
    {{ucbinding}}_CONSTEXPR inline Version(unsigned char majorVersion, unsigned char minorVersion);
    ...
    */
    {{ucbinding}}_CONSTEXPR inline Version(const Version & version);
    ...
    *    the major version
    */
    {{ucbinding}}_CONSTEXPR inline unsigned char majorVersion() const;
    ...
    *    the minor version
    */
    {{ucbinding}}_CONSTEXPR inline unsigned char minorVersion() const;
    ...
    */
    {{ucbinding}}_API inline std::string toString() const;
    ...
    */
    {{ucbinding}}_CONSTEXPR inline bool isNull() const;
    ...
    */
    {{ucbinding}}_CONSTEXPR inline bool operator<(const Version & version) const;
