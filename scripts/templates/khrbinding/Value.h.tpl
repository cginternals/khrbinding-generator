...
*/
template <typename T>
class {{ucbinding}}_TEMPLATE_API Value : public AbstractValue
{
public:
    /**
    *  @brief
    ...
    */
    {{ucbinding}}_CONSTEXPR inline Value(const T & value);
    ...
    *    The value
    */
    {{ucbinding}}_CONSTEXPR inline T value() const;
